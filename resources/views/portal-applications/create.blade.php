    ...
    <main class="px-4 py-8 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-5xl">
            <div class="mb-6">
                ...
                <h1 class="mt-1 text-3xl font-extrabold tracking-tight text-ink">Tambah aplikasi</h1>
            </div>

            <form method="POST" action="{{ route('portal-applications.store') }}" class="rounded-[28px] border border-white/80 bg-white/85 p-6 shadow-soft sm:p-8">
                @csrf
